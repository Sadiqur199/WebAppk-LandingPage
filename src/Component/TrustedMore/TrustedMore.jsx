  ...
  return (
    <div className='md:w-[1100px] mx-auto'>
      <div className='text-center mt-[100px]'>
        ...
        <p className='text-[#808080] text-center '>they have asked us more than 3 times to teach their employees  about various things. to improve their skills</p>
        <div className='grid grid-cols-2 md:grid-cols-5 gap-4 mt-10 mb-10 md:mx-0 mx-[50px]'>
          ...
          <img src={Img5} className=' w-[100px] h-[30px] md:ml-0 ml-[50%]' alt="" />
